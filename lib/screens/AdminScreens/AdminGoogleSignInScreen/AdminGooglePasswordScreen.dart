...
class AdminGoogleSignInPasswordScreen extends StatefulWidget {
  const AdminGoogleSignInPasswordScreen({Key? key}) : super(key: key);
  static String routeName = "/google-signin-password-screen";

  @override
  State<AdminGoogleSignInPasswordScreen> createState() =>
      _AdminGoogleSignInPasswordScreenState();
}

class _AdminGoogleSignInPasswordScreenState
    extends State<AdminGoogleSignInPasswordScreen> {
