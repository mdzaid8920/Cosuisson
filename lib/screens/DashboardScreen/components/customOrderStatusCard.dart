import 'package:cuission/screens/DashboardScreen/components/customStatusBadge.dart';
...
class CustomOrderStatusCard extends StatelessWidget {
  const CustomOrderStatusCard({
    ...
    required this.orderStatus, required this.imgSrc, required this.badgeColor,
  }) : super(key: key);
